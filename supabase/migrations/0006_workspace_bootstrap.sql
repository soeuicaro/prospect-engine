-- =============================================================================
-- 0006_workspace_bootstrap.sql — create_workspace(): atomically creates a
-- workspace, makes the caller an admin member, and seeds sensible editable
-- defaults (pipeline stages, scoring weights/rules, starter offers,
-- templates, playbooks, content ideas) so the product is usable immediately.
-- Everything it inserts is ordinary workspace-scoped data — fully editable
-- afterwards from Settings. Nothing here is hardcoded into the UI.
-- =============================================================================
...
comment on function public.create_workspace is 'Atomic workspace bootstrap: creates workspace, adds caller as admin, seeds editable default pipeline/scoring/offers/templates.';
